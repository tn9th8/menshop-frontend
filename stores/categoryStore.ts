import { getAllCategories, getCategoriesForClient, getCategoryDetail } from 'API/category'
...
class CategoryStore {
  ...
  async fetchCategoriesForClient(): Promise<void> {
    const categories = await getCategoriesForClient()
